...
{
	/// <summary>
	/// Represents the error that occurs when trying to connect the NVDA driver while previously connected.
	/// </summary>
	/// <seealso cref="NvdaTestingDriver.Exceptions.NvdaException" />
	[Serializable]
	public class AlreadyConnectedException : NvdaException
	{
		/// <summary>
