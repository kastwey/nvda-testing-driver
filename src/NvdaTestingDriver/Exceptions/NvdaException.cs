...
{
	/// <summary>
	/// Represents errors that occur during NVDATestingDriver execution.
	/// </summary>
	/// <seealso cref="System.Exception" />
	[Serializable]
	public class NvdaException : Exception
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="NvdaException"/> class.
		/// </summary>
		public NvdaException()
		{
		}
		...
		public NvdaException(string message)
			: base(message)
		{
		}
		...
		public NvdaException(string message, Exception innerException)
		...
		protected NvdaException(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
	}
